...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    plt.figure()
    plt.plot([e.cpu() for e in result_lists["train_acc"]], label='Train Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    ...
    plt.figure()
    plt.plot([e.cpu() for e in result_lists["val_acc"]], label='Validation Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    ...
    # Plot Train Loss
    plt.figure()
    plt.plot([e for e in result_lists["train_loss"]], label='Train Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    ...
    plt.figure()
    plt.plot([e for e in result_lists["val_loss"]], label='Validation Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
